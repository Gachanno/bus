...
<body>
    <main>
        <div class="authorization__box">
            ...
            <form method="POST" action="/bus-reg/login" class="authorization__form authorization__form--active" novalidate data-js-form>
                @csrf
                <label class="authorization__input-box">
                    <span>Электронная почта</span>
                    <input type="email" required class="authorization__input" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="имя_вашей_почты@домен.имя">
            ...
            <form method="POST" action="/bus-reg/register" class="authorization__form" novalidate data-js-form>
                @csrf
                <label class="authorization__input-box">
                    <span>Логин</span>
